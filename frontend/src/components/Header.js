...
function Header({ onFetchFeeds, fetching, fastMode, onToggleFastMode, onReCategorize, onOpenFetchSettings }) {
        ...
        <div className="header-actions">
          ...
          <div className="fetch-buttons">
            <button
              ...
              onClick={onOpenFetchSettings}
              disabled={fetching}
              title="Advanced Fetch Settings"
            >
